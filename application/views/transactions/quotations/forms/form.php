                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header bg-body-tertiary trans-header-static trans-theme modal-header-center-sticky d-flex justify-content-between align-items-center pb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <?php if ($isDraftEdit): ?>
                                <button type="submit" name="action" value="draft" class="btn btn-outline-secondary"><i class="bx bx-save me-1"></i><?php echo t('btn_save_draft', 'Save as Draft'); ?></button>
                                <?php endif; ?>
                            ...
                            <div class="row g-2 align-items-end mb-2">
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <button type="button" id="addTransCustomer" class="trans-add-btn btn btn-outline-primary btn-sm" aria-label="Add new customer" style="font-size:.72rem;white-space:nowrap;"><i class="bx bx-plus-circle me-1"></i><?php echo t('btn_add_customer', 'Add Customer'); ?></button>
                                    </div>

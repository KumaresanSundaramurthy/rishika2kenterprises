...
$_from    = $this->pageData['_iwsInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_iwsInitTo']   ?? date('Y-m-d');
...
.iws-cat-chip{display:inline-block;padding:1px 7px;border-radius:5px;font-size:.72rem;font-weight:600;background:#f1f5f9;color:#475569}
@media(prefers-color-scheme:dark){
    ...
    .iws-cat-chip{background:#334155;color:#94a3b8}
}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Item Wise Sales',
                    'pageDescription' => 'Product-wise total sales quantity and value',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="iwsFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="iwsFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="iwsToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="iwsTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="iwsApplyBtn">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Products Sold</div>
                                    <div class="rpt-stat-val" id="iwsStatProducts">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="iwsStatInvoices">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="iwsStatQty">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="iwsStatValue">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="iwsTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="iwsFtInvoices"></td>
                                        <td class="rpt-col-num rpt-num-teal" id="iwsFtQty"></td>
                                        <td class="rpt-col-num"></td>
                                        <td class="rpt-col-num rpt-num-green" id="iwsFtValue"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="iwsTblFooter">
                            <div class="rpt-footer-left"><span id="iwsRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-green"><i class="bx bx-money"></i>Total: <span id="iwsFooterValue"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _iwsInitFrom = '<?php echo addslashes($_from); ?>';
var _iwsInitTo   = '<?php echo addslashes($_to); ?>';
var _iwsListFmt  = '<?php echo addslashes($_listFmt); ?>';
ajaxLoading(0);
...
<script src="/js/reports/item_wise_sales.js"></script>

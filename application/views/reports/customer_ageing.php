...
.age-bucket-0{color:#16a34a}
.age-bucket-1{color:#ca8a04}
.age-bucket-2{color:#ea580c}
.age-bucket-3{color:#dc2626;font-weight:700}
.age-bucket-4{color:#991b1b;font-weight:700}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Customer Ageing',
                    'pageDescription' => 'Age-wise overdue receivables from customers',
                    'pageIcon'        => 'bx-time-five',
                    'pageIconBg'      => '#fee2e2',
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Total Outstanding</div>
                                    <div class="rpt-stat-val" id="caStatTotal">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-purple"><i class="bx bx-check-circle"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Current (0–30 days)</div>
                                    <div class="rpt-stat-val" id="caStatCurrent">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Overdue 31–90 days</div>
                                    <div class="rpt-stat-val" id="caStatMid">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Overdue 90+ days</div>
                                    <div class="rpt-stat-val" id="caStatOld">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="rpt-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Customer</th>
                                        <th>Mobile</th>
                                        <th class="rpt-col-num-hd age-bucket-0">0–30 days</th>
                                        <th class="rpt-col-num-hd age-bucket-1">31–60 days</th>
                                        <th class="rpt-col-num-hd age-bucket-2">61–90 days</th>
                                        <th class="rpt-col-num-hd age-bucket-3">91–120 days</th>
                                        <th class="rpt-col-num-hd age-bucket-4">120+ days</th>
                                        <th class="rpt-col-num-hd">Total</th>
                                    </tr>
                                </thead>
                                ...
                                <tfoot id="caTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="3">Total</td>
                                        <td class="rpt-col-num age-bucket-0" id="caFt0_30"></td>
                                        <td class="rpt-col-num age-bucket-1" id="caFt31_60"></td>
                                        <td class="rpt-col-num age-bucket-2" id="caFt61_90"></td>
                                        <td class="rpt-col-num age-bucket-3" id="caFt91_120"></td>
                                        <td class="rpt-col-num age-bucket-4" id="caFt120Plus"></td>
                                        <td class="rpt-col-num rpt-num-red" id="caFtTotal"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="caTblFooter">
                            <div class="rpt-footer-left"><span id="caRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-red"><i class="bx bx-error-circle"></i>Total Overdue: <span id="caFooterTotal"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _caToday   = '<?php echo $_today; ?>';
var _caListFmt = '<?php echo addslashes($_listFmt); ?>';
ajaxLoading(0);
...
<script src="/js/reports/customer_ageing.js"></script>

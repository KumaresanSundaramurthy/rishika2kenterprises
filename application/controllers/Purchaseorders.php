...
class Purchaseorders extends CI_Controller {
    ...
    public function getPurchaseOrdersPageDetails($pageNo = 0) {
    ...
    public function addPurchaseOrder() {
        ...
        try {
            ...
            $this->savePOItems($transUID, $financialYear, $orgUID, $userUID, $items);
    ...
    public function updatePurchaseOrder() {
        ...
        try {
            ...
            if ($existing->DocStatus === 'Draft' && !$isDraft
                ...
                $this->savePOItems($newTransUID, $financialYear, $orgUID, $userUID, $items);
                ...
                $this->savePOItems($transUID, $financialYear, $orgUID, $userUID, $items, $seqOffset);
            }
    ...
    private function _saveAttachments($transUID) {
        ...
        for ($i = 0; $i < $fileCount; $i++) {
            ...
            $storagePath = 'purchaseorders/' . $transUID . '/' . $safeName;
    ...
    public function uploadAttachments() {
        ...
        try {
            ...
            if ($transUID <= 0) throw new Exception('Invalid purchase order reference.');

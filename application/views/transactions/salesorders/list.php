                    ...
                    <ul class="dropdown-menu dropdown-menu-end r2k-action-menu">
                        ...
                        <li>
                            <button class="dropdown-item downloadPdfTransaction" data-uid="<?php echo (int)$list->TransUID; ?>" data-module="<?php echo (int)$list->ModuleUID; ?>">
                                <i class="bx bxs-file-pdf me-2 text-danger"></i><?php echo t('act_download_pdf', 'Download PDF'); ?>
                            </button>
                        </li>
                        <li>
                        ...
                        <li>
                            <button class="dropdown-item convertSOToChallan"
                                    data-uid="<?php echo (int)$list->TransUID; ?>"
                                    data-num="<?php echo htmlspecialchars($list->UniqueNumber ?? ''); ?>">
                                <i class="bx bx-package me-2 text-info"></i><?php echo t('trans_convert_to_challan', 'Convert to Delivery Challan'); ?>
                            </button>
                        </li>
                        <?php $hasPrinted = true; endif; ?>
    ...
    <tr>
        <td colspan="9">
            <div class="d-flex flex-column align-items-center py-5">
                ...
                <span class="text-muted mb-3" style="font-size:.9rem;"><?php echo t('empty_sales_orders', 'No sales orders found'); ?></span>
                <a href="/salesorders/create" class="btn btn-primary btn-sm px-4">
                    <i class="bx bx-plus me-1"></i><?php echo t('create_sales_order', 'Create Sales Order'); ?>
                </a>
            </div>
        </td>
    </tr>

...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end" id="dateFilterMenu" style="width:240px;max-height:420px;overflow-y:auto;font-size:.82rem;z-index:9999;border-radius:12px;border:1px solid #c4c6f8;box-shadow:0 8px 32px rgba(105,108,255,.18);"></ul>
</div>
<?php $this->load->view('common/transactions/trans_date_range'); ?>
...
$_from    = $this->pageData['_iiInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_iiInitTo']   ?? date('Y-m-d');
...
.bw-doc-chip{display:inline-block;padding:1px 7px;border-radius:5px;font-size:.72rem;font-weight:600;background:#fef9c3;color:#854d0e;white-space:nowrap}
@media(prefers-color-scheme:dark){
    ...
    .bw-doc-chip{background:#1c1208;color:#ca8a04}
}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Invoice Item-wise',
                    'pageDescription' => 'Each invoice line-item with rate, qty and tax',
                    'pageIcon'        => 'bx-detail',
                    'pageIconBg'      => '#fef9c3',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="iiFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="iiFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="iiToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="iiTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="iiApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-yellow"><i class="bx bx-receipt"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Line Items</div>
                                    <div class="rpt-stat-val" id="iiStatItems">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="iiStatQty">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="iiStatTax">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="iiStatNet">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="iiTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="5">Total</td>
                                        <td class="rpt-col-num" id="iiFtQty"></td>
                                        <td></td>
                                        <td></td>
                                        <td class="rpt-col-num" id="iiFtTaxable"></td>
                                        <td></td>
                                        <td class="rpt-col-num rpt-num-yellow" id="iiFtTax"></td>
                                        <td class="rpt-col-num rpt-num-green" id="iiFtNet"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="iiTblFooter">
                            <div class="rpt-footer-left"><span id="iiRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-yellow"><i class="bx bx-money-withdraw"></i>Tax: <span id="iiFooterTax"></span></span>
                                <span class="rpt-footer-chip rpt-footer-chip-green"><i class="bx bx-money"></i>Net: <span id="iiFooterNet"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _iiInitFrom = '<?php echo addslashes($_from); ?>';
var _iiInitTo   = '<?php echo addslashes($_to); ?>';
var _iiListFmt  = '<?php echo addslashes($_listFmt); ?>';
ajaxLoading(0);
...
<script src="/js/reports/invoice_itemwise.js"></script>

...
.spay-logout-link {
    ...
    font-size: 0.78rem; color: rgba(220, 100, 100, 0.75);
    text-decoration: none;
    border: 1px solid rgba(220, 100, 100, 0.25); border-radius: 100px;
    padding: 0.35rem 0.85rem;
    transition: color 0.2s, border-color 0.2s, background 0.2s;
}
.spay-logout-link:hover { color: rgba(240, 120, 120, 1); border-color: rgba(220, 100, 100, 0.55); background: rgba(220, 100, 100, 0.08); }
...
.spay-back a {
    display: inline-flex; align-items: center; gap: 0.4rem;
    font-size: 0.82rem; color: rgba(160, 190, 215, 0.5);
    text-decoration: none;
    transition: color 0.2s;
}
.spay-back a:hover { color: rgba(160, 190, 215, 0.9); }
...
.spay-total-amount {
    font-size: 2rem; font-weight: 800; color: #f0f4f8;
    letter-spacing: -0.03em; line-height: 1;
}
.spay-total-amount sup {
...
.spay-trust {
    ...
    font-size: 0.75rem; color: rgba(160, 190, 215, 0.38);
...
.spay-btn {
    ...
    box-shadow: 0 6px 28px rgba(105, 108, 255, 0.38);
    margin-bottom: 1rem;
}
.spay-btn:hover:not(:disabled) {
    background: linear-gradient(135deg, #7b7fff 0%, #696cff 100%);
    box-shadow: 0 8px 36px rgba(105, 108, 255, 0.55);
        ...
        <div class="spay-card">
            ...
            <div id="spayMain">
                ...
                <div class="spay-summary">
                    ...
                    <div class="spay-row">
                        <span class="spay-row-label">GST 18%</span>
                ...
                <a href="<?= site_url('subscribe') ?>" style="display:block;text-align:center;font-size:0.78rem;color:rgba(160,190,215,.35);text-decoration:none;transition:color .2s;"
...
(function () {
    ...
    function _spayVerifyPayment(response, orderId) {
        ...
        .then(function (data) {
            ...
            document.getElementById('spayMain').style.display    = 'none';
            document.getElementById('spaySuccess').classList.add('show');
        })
        .catch(function () {
            spaySetLoading(false);

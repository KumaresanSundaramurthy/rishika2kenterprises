...
<?php else: ?>
    ...
    <div class="row g-3">
        ...
        <?php
            $isDefault   = (int) $bank->IsDefault === 1;
            $maskLen     = max(0, strlen($bank->AccountNumber) - 4);
            $maskedAccNo = str_repeat('•', $maskLen) . substr($bank->AccountNumber, -4);
        ?>
        <div class="col-xl-4 col-md-6" id="bankCard_<?php echo $bank->BankAccountUID; ?>">
            <div class="card h-100 <?php echo $isDefault ? 'border-primary' : ''; ?>" style="<?php echo $isDefault ? 'border-width:2px;' : ''; ?>">
                <div class="card-body pb-2">

                    <!-- Header row: bank name + default badge -->
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div class="d-flex align-items-center gap-2">
                            <div class="avatar avatar-sm" style="background:linear-gradient(135deg,#696cff,#4a4fc4);border-radius:8px;width:36px;height:36px;display:flex;align-items:center;justify-content:center;">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            ...
                            <button class="btn btn-sm btn-link text-muted p-0 setDefaultBankBtn"
                                data-uid="<?php echo $bank->BankAccountUID; ?>"

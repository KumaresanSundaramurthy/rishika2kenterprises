      ...
      <div class="content-wrapper apex-content">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-6 col-md"><div class="trans-stat-card stat-converted"><div class="trans-stat-label">Paid</div><div class="trans-stat-count"><?php echo (int)($st->Paid ?? 0); ?></div><div class="trans-stat-amount"><?php echo $cur . ' ' . number_format((float)($st->TotalPaid ?? 0), $dec); ?></div><i class="bx bx-money trans-stat-icon"></i></div></div>
          </div>

...
<?php if ($AddressType == 1) { ?>
    ...
    <div class="card mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button type="button" id="deleteBillingAddress" class="btn btn-danger btn-sm"><i class="bx bx-trash me-1"></i> </button>
        </div>
        <div class="card-body">
            <div class="row">

                <input type="hidden" name="BillAddressUID" id="BillAddressUID" value="0" />
                <div class="mb-3 col-md-12">
                    <label for="BillAddrLine1" class="form-label">Address Line 1 <span style="color:red">*</span></label>
                    <input class="form-control" type="text" id="BillAddrLine1" name="BillAddrLine1" maxlength="100" placeholder="Address Line 1" required />
                </div>
                <div class="mb-3 col-md-12">
                ...
                <div class="mb-3 col-md-12">
                    ...
                    <input class="form-control" type="text" id="BillAddrPincode" name="BillAddrPincode" maxlength="10" placeholder="Pincode" required />
                </div>
...
<?php } else if ($AddressType == 2) { ?>
    ...
    <div class="card mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button type="button" id="deleteShippingAddress" class="btn btn-danger btn-sm"><i class="bx bx-trash me-1"></i> </button>
        </div>
        <div class="card-body">
            <div class="row">

                <input type="hidden" name="ShipAddressUID" id="ShipAddressUID" value="0" required />
                <div class="mb-3 col-md-12">
                    <label for="ShipAddrLine1" class="form-label">Address Line 1 <span style="color:red">*</span></label>
                    <input class="form-control" type="text" id="ShipAddrLine1" name="ShipAddrLine1" maxlength="100" placeholder="Address Line 1" required />
                </div>
                <div class="mb-3 col-md-12">
                    <label for="ShipAddrLine2" class="form-label">Address Line 2 </label>
                    <input class="form-control" type="text" id="ShipAddrLine2" name="ShipAddrLine2" maxlength="100" placeholder="Address Line 2" />
                </div>
                <div class="mb-3 col-md-12">
                    <label for="ShipAddrPincode" class="form-label">Pincode <span style="color:red">*</span></label>
                    <input class="form-control" type="text" id="ShipAddrPincode" name="ShipAddrPincode" maxlength="10" placeholder="Pincode" required />
                </div>
                <div class="mb-3 col-md-6">

...
<div class="layout-wrapper transactionPage layout-content-navbar">
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <?php $FormAttribute = ['id' => 'addCNForm', 'name' => 'addCNForm', 'autocomplete' => 'off', 'data-csrf' => $this->security->get_csrf_token_name(), 'data-csrf-value' => $this->security->get_csrf_hash()];
                    echo form_open('creditnotes/addCreditNote', $FormAttribute); ?>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header bg-body-tertiary trans-header-static trans-theme modal-header-center-sticky d-flex justify-content-between align-items-center pb-3">
                            <div class="d-flex flex-wrap align-items-center gap-3" id="transHeaderInfo">
                                <h5 class="modal-title mb-0 ms-2">Create Credit Note</h5>
                                <div class="d-flex align-items-center gap-1">
                                    <div class="input-group w-auto">
                                        ...
                                        function buildCNInitialPrefixSegment($cfg) {
                                            if (!$cfg) return '';
                                            $sep = $cfg->Separator ?? '-';
                                            $parts = [$cfg->Name];
                                        ...
                                        $initialPrefixSeg = buildCNInitialPrefixSegment($defaultPrefixConfig);
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="/creditnotes" class="btn btn-label-danger">Close</a>
                            </div>
                        </div>
                        ...
                        <div class="card-body card-body-form-static p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-2">
                                        <label for="transDate" class="form-label small fw-semibold">Credit Note Date <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2"><label for="transNotes" class="form-label small fw-semibold">Notes</label><textarea class="form-control" name="transNotes" id="transNotes" rows="2" placeholder="Reason for credit note"></textarea></div>
    ...
    if ($form.length) {
        $form.on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function() { setFormLoading('#addCNForm', false); showFormError('Server error. Please try again.'); }
            });
        });

...
$_from    = $this->pageData['_prInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_prInitTo']   ?? date('Y-m-d');
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Purchase Return Item-wise',
                    'pageDescription' => 'Returned items per debit note in detail',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="prFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="prFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="prToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="prTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="prApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="prStatItems">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="prStatQty">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="prStatTax">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="prStatNet">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                            ...
                            <table class="rpt-table">
                                ...
                                <tfoot id="prTableFoot" class="d-none">
                                    <tr>
                                        ...
                                        <td class="rpt-col-num" id="prFtQty"></td>
                                        <td></td>
                                        <td></td>
                                        <td class="rpt-col-num" id="prFtTaxable"></td>
                                        <td></td>
                                        <td class="rpt-col-num rpt-num-yellow" id="prFtTax"></td>
                                        <td class="rpt-col-num rpt-num-orange" id="prFtNet"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="prTblFooter">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-yellow"><i class="bx bx-money-withdraw"></i>Tax: <span id="prFooterTax"></span></span>
                                <span class="rpt-footer-chip rpt-footer-chip-orange"><i class="bx bx-money"></i>Return Value: <span id="prFooterNet"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _prInitFrom = '<?php echo addslashes($_from); ?>';
var _prInitTo   = '<?php echo addslashes($_to); ?>';
...
<script src="/js/reports/purchase_return_itemwise.js"></script>

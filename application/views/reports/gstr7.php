...
.rpt-icon-dark{background:#f1f5f9}.rpt-icon-dark i{color:#334155}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'GSTR-7',
                    'pageDescription' => 'TDS Deducted on Vendor Payments — Tax Deduction at Source',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="g7FromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="g7From" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="g7ToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="g7To" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="g7ApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body"><div class="rpt-stat-label">TDS Entries</div><div class="rpt-stat-val" id="g7StatCount">—</div></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-orange"><i class="bx bx-store"></i></div>
                                <div class="rpt-stat-body"><div class="rpt-stat-label">Vendors</div><div class="rpt-stat-val" id="g7StatVendors">—</div></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-yellow"><i class="bx bx-rupee"></i></div>
                                <div class="rpt-stat-body"><div class="rpt-stat-label">Total Base Amount</div><div class="rpt-stat-val" id="g7StatBase">—</div></div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-dark"><i class="bx bx-minus-circle"></i></div>
                                <div class="rpt-stat-body"><div class="rpt-stat-label">Total TDS Deducted</div><div class="rpt-stat-val" id="g7StatTds">—</div></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                <thead><tr>
                                    ...
                                    <th class="rpt-col-num-hd">TDS Amount</th>
                                    <th class="rpt-col-num-hd">Net Paid</th>
                                    <th>Status</th>
                                </tr></thead>
                                <tbody id="g7TableBody"><tr><td colspan="12" class="rpt-loading-cell"><div class="rpt-loading"><span class="spinner-border spinner-border-sm me-2"></span>Loading…</div></td></tr></tbody>
                                <tfoot id="g7TableFoot" class="d-none"><tr>
                                    <td colspan="7">Total</td>
                                    <td class="rpt-col-num" id="g7FtBase"></td>
                                    <td></td>
                                    <td class="rpt-col-num rpt-num-red" id="g7FtTds"></td>
                                    <td class="rpt-col-num rpt-num-blue" id="g7FtNet"></td>
                                    <td></td>
                                </tr></tfoot>
                            </table>
                        </div>
...
<script>
var _g7InitFrom = '<?php echo addslashes($_from); ?>';
var _g7InitTo   = '<?php echo addslashes($_to); ?>';
ajaxLoading(0);
...
<script src="/js/reports/gstr7.js"></script>

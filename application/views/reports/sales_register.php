...
$_from    = $this->pageData['_sregInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_sregInitTo']   ?? date('Y-m-d');
...
.reg-status-partial{background:#fef9c3;color:#854d0e}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    ...
                    'pageDescription' => 'Invoice-wise sales with tax breakup in a date range',
                    'pageIcon'        => 'bx-store-alt',
                    'pageIconBg'      => '#ccfbf1',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="sregFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="sregFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="sregToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="sregTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="sregApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-teal"><i class="bx bx-receipt"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Invoices</div>
                                    <div class="rpt-stat-val" id="sregStatCount">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="sregStatTaxable">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="sregStatTax">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="sregStatNet">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="sregTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="sregFtTaxable"></td>
                                        <td class="rpt-col-num" id="sregFtCgst"></td>
                                        <td class="rpt-col-num" id="sregFtSgst"></td>
                                        <td class="rpt-col-num" id="sregFtIgst"></td>
                                        <td class="rpt-col-num rpt-num-yellow" id="sregFtTax"></td>
                                        <td class="rpt-col-num rpt-num-green" id="sregFtNet"></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="sregTblFooter">
                            <div class="rpt-footer-left"><span id="sregRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-yellow"><i class="bx bx-transfer"></i>Tax: <span id="sregFooterTax"></span></span>
                                <span class="rpt-footer-chip rpt-footer-chip-green"><i class="bx bx-money"></i>Net: <span id="sregFooterNet"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _sregInitFrom = '<?php echo addslashes($_from); ?>';
var _sregInitTo   = '<?php echo addslashes($_to); ?>';
ajaxLoading(0);
...
<script src="/js/reports/sales_register.js"></script>

...
class Salesorders extends CI_Controller {
    ...
    public function updateSalesOrder() {
        ...
        try {
            ...
            if ($existing->DocStatus === 'Draft' && !$isDraft
                ...
                $this->saveSalesOrderItems($newTransUID, $financialYear, $orgUID, $userUID, $items);
                ...
                $this->saveSalesOrderItems($transUID, $financialYear, $orgUID, $userUID, $items, $seqOffset);
            }
    ...
    public function getSalesOrderDetail() {
        ...
        try {
            ...
            if (!$header) throw new Exception('Sales Order not found.');
    ...
    private function saveSalesOrderItems($transUID, $financialYear, $orgUID, $userUID, array $items, $seqOffset = 0) {
    ...
    private function _saveAttachments($transUID) {
        ...
        for ($i = 0; $i < $fileCount; $i++) {
            ...
            $storagePath = 'salesorders/' . $transUID . '/' . $safeName;
    ...
    public function uploadAttachments() {
        ...
        try {
            ...
            if ($transUID <= 0) throw new Exception('Invalid sales order reference.');

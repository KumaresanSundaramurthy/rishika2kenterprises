                            ...
                            <div class="d-flex flex-wrap align-items-center gap-3" id="transHeaderInfo">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    <div class="input-group w-auto">
                                        ...
                                        function buildSRInitialPrefixSegment($cfg) {
                                            if (!$cfg) return '';
                                            $sep    = $cfg->Separator ?? '-';
                                            $parts  = [$cfg->Name];
                                        ...
                                        $initialPrefixSeg = buildSRInitialPrefixSegment($defaultPrefixConfig);
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <textarea class="form-control" name="transNotes" id="transNotes" rows="2" placeholder="Enter notes or reason for return"></textarea>
                                    </div>
                                    <div class="mb-2">
                                        <label for="transTermsCond" class="form-label small fw-semibold">Terms & Conditions</label>
                                        <textarea class="form-control" name="transTermsCond" id="transTermsCond" rows="2" placeholder="Enter terms & conditions"></textarea>
                                    </div>
                                </div>

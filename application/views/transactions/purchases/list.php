...
$statusTransitions = [
    'Draft'     => [
        ['db' => 'Received', 'label' => 'Receive Bill'],
    ],
    'Received'  => [
...
if (!empty($DataLists)) {
    foreach ($DataLists as $list) {
        ...
        $isPaid      = ($list->Status === 'Paid');
        $isCancelled = ($list->Status === 'Cancelled');
        $isTerminal  = $isPaid || $isCancelled;
        ...
        <tr>
            ...
            <td>
                ...
                <?php else: ?>
                    <span class="fw-semibold text-primary">
                        <a href="javascript:void(0)" class="text-decoration-underline viewPurchase" data-uid="<?php echo (int) $list->TransUID; ?>">
            ...
            <td class="<?php echo $dueClass; ?>">
                <?php if (!$isDraft && !empty($list->ValidityDate)): ?>
                    ...
                    <?php if ($dueClass): ?><br><small>Overdue</small><?php endif; ?>
                <?php else: ?>
                    <span class="text-muted">—</span>
                <?php endif; ?>
            </td>
                ...
                <div class="d-flex align-items-center justify-content-center gap-1">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                            ...
                            <?php if (!$isDraft): ?>
                            <li>
                                <button class="dropdown-item a4PrintPurchase"
                                        data-uid="<?php echo (int) $list->TransUID; ?>">
                            ...
                            <li>
                                <button class="dropdown-item duplicatePurchase"
                                        data-uid="<?php echo (int) $list->TransUID; ?>">
    ...
    <tr>
        <td colspan="10">
            <div class="d-flex flex-column align-items-center py-5">
                ...
                <span class="text-muted mb-3">No purchase bills found</span>

                ...
                <div class="card mb-3">
                    <div class="card-header bg-body-tertiary trans-header-static trans-theme modal-header-center-sticky d-flex justify-content-between align-items-center pb-3">
                        <div class="d-flex flex-wrap align-items-center gap-3" id="transHeaderInfo">
                            ...
                            <?php if (!$isDraftEdit && !empty($PRData->UniqueNumber)): ?><span class="badge bg-label-success fs-6"><?php echo htmlspecialchars($PRData->UniqueNumber); ?></span><?php endif; ?>
...
$(function() {
    ...
    if ($form.length) {
        $form.on('submit', function(e) {
            ...
            $.ajax({ url: '/purchasereturns/updatePurchaseReturn', method: 'POST', data: postData, cache: false,

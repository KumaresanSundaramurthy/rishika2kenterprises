                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" name="ComboSellingPrice" id="ComboSellingPrice" min="0" placeholder="Enter Selling Price" onkeydown="return handleDotOnly(event)" oninput="this.value=this.value.slice(0,this.maxLength); validatePriceInput(this, 18, 8)" maxLength="28" required />
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><?php echo $JwtData->GenSettings->CurrenySymbol; ?></span>
                                <input type="text" class="form-control" name="ComboPurchasePrice" id="ComboPurchasePrice" min="0" placeholder="Enter Purchase Price" onkeydown="return handleDotOnly(event)" oninput="this.value=this.value.slice(0,this.maxLength); validatePriceInput(this, 18, 8)" maxLength="28" onpaste="handlePricePaste(event, 18, 8)" ondrop="handlePriceDrop(event, 18, 8)" required />
...
<script>
var _comboQtyMaxLen = 18;
var _comboQtyDecimals = 8;
</script>

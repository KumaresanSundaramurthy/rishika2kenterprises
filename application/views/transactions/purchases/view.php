                    ...
                    <div class="card">
                        ...
                        <div class="apex-filter-row">
                            <div class="apex-search-wrap">
                                ...
                                <input type="text" id="searchTransactionData" class="apex-search-input" placeholder="Bill # or vendor...">
                            ...
                            <a href="/purchases/create" class="btn btn-sm btn-primary"><i class="bx bx-plus me-1"></i>New Purchase Bill</a>
                        </div>

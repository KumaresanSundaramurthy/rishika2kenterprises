...
$_from    = $this->pageData['_srrInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_srrInitTo']   ?? date('Y-m-d');
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Sales Return Register',
                    'pageDescription' => 'Credit note-wise sales returns in a date range',
                    'pageIcon'        => 'bx-undo',
                    'pageIconBg'      => '#fee2e2',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="srrFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="srrFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="srrToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="srrTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="srrApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Credit Notes</div>
                                    <div class="rpt-stat-val" id="srrStatCount">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="srrStatTaxable">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="srrStatTax">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="srrStatNet">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="srrTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="srrFtTaxable"></td>
                                        <td class="rpt-col-num" id="srrFtCgst"></td>
                                        <td class="rpt-col-num" id="srrFtSgst"></td>
                                        <td class="rpt-col-num" id="srrFtIgst"></td>
                                        <td class="rpt-col-num rpt-num-yellow" id="srrFtTax"></td>
                                        <td class="rpt-col-num rpt-num-red" id="srrFtNet"></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="srrTblFooter">
                            <div class="rpt-footer-left"><span id="srrRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-yellow"><i class="bx bx-transfer"></i>Tax: <span id="srrFooterTax"></span></span>
                                <span class="rpt-footer-chip rpt-footer-chip-red"><i class="bx bx-money"></i>Return Value: <span id="srrFooterNet"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _srrInitFrom = '<?php echo addslashes($_from); ?>';
var _srrInitTo   = '<?php echo addslashes($_to); ?>';
ajaxLoading(0);
...
<script src="/js/reports/sales_return_register.js"></script>

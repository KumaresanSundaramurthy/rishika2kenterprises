    ...
    <tr>
        ...
        <td>
            <div class="fw-semibold">
                <button type="button" class="btn btn-link p-0 text-body fw-semibold vgrp-view-btn" data-uid="<?php echo $uid; ?>" style="text-decoration:none;font-size:inherit;"><?php echo $name; ?></button>
            </div>
        ...
        <td>
            <div class="d-flex align-items-center gap-1">
                <button type="button" class="btn btn-icon btn-sm text-info vgrp-view-btn" data-uid="<?php echo $uid; ?>" title="View Detail"><i class="bx bx-show"></i></button>
                <button type="button" class="btn btn-icon btn-sm text-warning vgrp-edit-btn" data-uid="<?php echo $uid; ?>" title="Edit"><i class="bx bx-edit"></i></button>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width:140px;font-size:.82rem;">
                        <li>
                            <button class="dropdown-item text-danger vgrp-delete-btn" data-uid="<?php echo $uid; ?>">

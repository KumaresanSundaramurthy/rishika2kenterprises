...
@media(prefers-color-scheme:dark){
    ...
    .rpt-table tfoot td,.rpt-tbl-footer{background:#0f172a;border-color:#334155}
}
...
:root[data-theme="dark"] .rpt-table tbody tr:hover,.rpt-table tfoot td{background:#0f172a}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Customer Outstanding',
                    'pageDescription' => 'Pending receivables from customers',
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-purple"><i class="bx bx-group"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Customers</div>
                                    <div class="rpt-stat-val" id="coStatCustomers">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="coStatInvoices">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-orange"><i class="bx bx-wallet-alt"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Total Billed</div>
                                    <div class="rpt-stat-val" id="coStatBilled">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="coStatOutstanding">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="rpt-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="rpt-col-num-hd">Total Billed</th>
                                        <th class="rpt-col-num-hd">Paid</th>
                                        <th class="rpt-col-num-hd">Outstanding</th>
                                    </tr>
                                </thead>
                                ...
                                <tfoot id="coTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="coFtInvoices"></td>
                                        <td class="rpt-col-num rpt-num-orange" id="coFtBilled"></td>
                                        <td class="rpt-col-num" id="coFtPaid"></td>
                                        <td class="rpt-col-num rpt-num-red" id="coFtOutstanding"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="coTblFooter">
                            <div class="rpt-footer-left"><span id="coRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-red"><i class="bx bx-error-circle"></i>Outstanding: <span id="coFooterOutstanding"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _coToday   = '<?php echo $_today; ?>';
var _coListFmt = '<?php echo addslashes($_listFmt); ?>';
ajaxLoading(0);
...
<script src="/js/reports/customer_outstanding.js"></script>

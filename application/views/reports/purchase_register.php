...
$_from    = $this->pageData['_pregInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_pregInitTo']   ?? date('Y-m-d');
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    ...
                    'pageDescription' => 'Purchase bill-wise report with tax breakup',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="pregFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="pregFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="pregToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="pregTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="pregApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Bills</div>
                                    <div class="rpt-stat-val" id="pregStatCount">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="pregStatTaxable">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="pregStatTax">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="pregStatNet">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="pregTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="pregFtTaxable"></td>
                                        <td class="rpt-col-num" id="pregFtCgst"></td>
                                        <td class="rpt-col-num" id="pregFtSgst"></td>
                                        <td class="rpt-col-num" id="pregFtIgst"></td>
                                        <td class="rpt-col-num rpt-num-yellow" id="pregFtTax"></td>
                                        <td class="rpt-col-num rpt-num-orange" id="pregFtNet"></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="pregTblFooter">
                            <div class="rpt-footer-left"><span id="pregRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-yellow"><i class="bx bx-transfer"></i>Tax: <span id="pregFooterTax"></span></span>
                                <span class="rpt-footer-chip rpt-footer-chip-orange"><i class="bx bx-money"></i>Net: <span id="pregFooterNet"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _pregInitFrom = '<?php echo addslashes($_from); ?>';
var _pregInitTo   = '<?php echo addslashes($_to); ?>';
ajaxLoading(0);
...
<script src="/js/reports/purchase_register.js"></script>

    ...
    <tr class="<?php echo $isOverdueRow ? 'trans-row-overdue' : ''; ?>">
        ...
        <td>
            <?php if ($isDraft || empty($list->UniqueNumber)): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a href="javascript:void(0)" class="trans-doc-number viewQuotation" data-uid="<?php echo (int)$list->TransUID; ?>">
            ...
            <div class="d-flex align-items-center justify-content-center gap-1">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="font-size:.82rem;min-width:180px;">
                        ...
                        <li>
                            <button class="dropdown-item thermalPrintQuotation" data-uid="<?php echo (int)$list->TransUID; ?>">
                                <i class="bx bx-receipt me-2 text-dark"></i>Thermal Print
                            </button>
                        </li>
                        <?php if (!empty($list->MobileNumber)): ?>
                        <li>
                            <a class="dropdown-item" href="https://wa.me/<?php echo htmlspecialchars($list->MobileNumber); ?>?text=Please+find+your+quotation+<?php echo htmlspecialchars($list->UniqueNumber ?? ''); ?>" target="_blank">
                                <i class="bx bxl-whatsapp me-2 text-success"></i>Send via WhatsApp
                            </a>
                        </li>
                        <?php endif; ?>

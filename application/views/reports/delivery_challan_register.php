...
$_from    = $this->pageData['_dcrInitFrom'] ?? date('Y-01-01');
$_to      = $this->pageData['_dcrInitTo']   ?? date('Y-m-d');
...
.reg-status-dispatched{background:#dbeafe;color:#1d4ed8}
.reg-status-converted{background:#dcfce7;color:#15803d}
        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    'pageTitle'       => 'Delivery Challan Register',
                    'pageDescription' => 'Dispatch-wise delivery challans in a date range',
                    'pageIcon'        => 'bx-package',
                    'pageIconBg'      => '#dbeafe',
                    ...
                    <div class="card mb-3">
                        <div class="rpt-filter-bar">
                            <div class="rpt-filter-group">
                                ...
                                <input type="text" id="dcrFromDisplay" class="form-control rpt-filter-date" placeholder="From date" readonly>
                                <input type="hidden" id="dcrFrom" value="<?php echo htmlspecialchars($_from); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">To</div>
                                <input type="text" id="dcrToDisplay" class="form-control rpt-filter-date" placeholder="To date" readonly>
                                <input type="hidden" id="dcrTo" value="<?php echo htmlspecialchars($_to); ?>">
                            </div>
                            <div class="rpt-filter-group">
                                <div class="rpt-filter-label">&nbsp;</div>
                                <button class="btn btn-primary" id="dcrApplyBtn"><i class="bx bx-search me-1"></i>Apply</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Challans</div>
                                    <div class="rpt-stat-val" id="dcrStatCount">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-teal"><i class="bx bx-group"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Customers</div>
                                    <div class="rpt-stat-val" id="dcrStatCustomers">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-yellow"><i class="bx bx-time-five"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Pending</div>
                                    <div class="rpt-stat-val" id="dcrStatPending">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Total Value</div>
                                    <div class="rpt-stat-val" id="dcrStatNet">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="dcrTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="dcrFtTaxable"></td>
                                        <td class="rpt-col-num" id="dcrFtTax"></td>
                                        <td class="rpt-col-num rpt-num-blue" id="dcrFtNet"></td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="dcrTblFooter">
                            <div class="rpt-footer-left"><span id="dcrRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-blue"><i class="bx bx-money"></i>Total Value: <span id="dcrFooterNet"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _dcrInitFrom = '<?php echo addslashes($_from); ?>';
var _dcrInitTo   = '<?php echo addslashes($_to); ?>';
ajaxLoading(0);
...
<script src="/js/reports/delivery_challan_register.js"></script>

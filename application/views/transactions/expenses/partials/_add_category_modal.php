...
<!-- Add / Rename Category Modal (shared by expense form and category manager) -->
        ...
        <div class="modal-content">
            <div class="modal-header bg-white border-bottom d-flex align-items-center justify-content-between px-3 py-2 trans-theme">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h6 class="modal-title mb-0" id="catModalTitle">Add Category</h6>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <button type="button" class="btn btn-sm btn-primary" id="saveCategoryBtn">
                        <i class="bx bx-check me-1"></i><span id="catSaveBtnLabel">Add</span>
                    </button>
            ...
            <div class="modal-body py-3">
                <input type="hidden" id="catModalUID" value="0">
                <input type="text" class="form-control" id="newCategoryName"
                       placeholder="Category name" maxlength="100" autocomplete="off">
                <div id="catSaveError" class="text-danger mt-1" style="font-size:.78rem;display:none;"></div>
            </div>
        </div>
    </div>
</div>

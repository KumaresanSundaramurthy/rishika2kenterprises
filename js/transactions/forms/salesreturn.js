        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                res.Invoices.forEach(function (inv) {
                    ...
                    var label = inv.UniqueNumber + ' | ' + dateLabel + ' | ' + (genSettings.CurrenySymbol || '₹') + parseFloat(inv.NetAmount).toFixed(2);
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.Error) {
                        ...
                        showUIBlock();
                        _setPendingToast('_srPendingToast', _isEdit ? response.Message : 'Sales Return created successfully.', 'success');

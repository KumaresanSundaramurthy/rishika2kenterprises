...
<body>
    ...
    <!-- Our Menu section -->
    <section id="our_menu_section_details" class="food_section layout_padding-bottom">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    Our Menu
            ...
            <div class="filters-content">
                <div class="row grid">
                    ...
                    <div class="col-sm-12 col-lg-8 all sweetssnacks d-none" id="other_sweets_snacks">
                        <div class="box">
                            <div class="d-flex">
    ...
    <!-- about section -->
    <section id="about_section_details" class="about_section layout_padding">
        <div class="container  ">
                    ...
                    <div class="row">
                        <div class="col-md-6 p-5">
                            <div class="section-header">
                                <h2 class="section-title display-3">Get <span class="text-warning">25% Discount</span> on your first purchase</h2>
                            </div>
                            <p class="d-none">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dictumst amet, metus, sit massa posuere maecenas. At tellus ut nunc amet vel egestas.</p>
                        </div>
                        <div class="col-md-6 px-5">

                            <form action="Services/Subscribesendemail" method="POST" id="CustomerDataForm" name="CustomerDataForm" class="" autocomplete="off">
                                ...
                                <div class="col-12 mb-3 p-0">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="col-7 p-0">
                                            <input type="text" name="SubsMobile" id="SubsMobile" class="form-control border-start-0" placeholder="Enter your mobile number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-2">
                        ...
                        <h4 class="mb-3 mt-4">Success</h4>
                        <p class="text-muted fs-15 mb-4" id="SuccessModalMessage">Success</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4 pt-4">
                        ...
                        <p class="text-muted" id="ErrorModalMessage">Error.</p>

                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <!-- <div id="SellingPriceTaxHelp" class="form-text text-danger">Inclusive of Taxes</div>
                                    <div id="SellingPriceWTaxHelp" class="form-text text-danger d-none">Exclusive of Taxes</div> -->
                                </div>
                                <div class="mb-3 col-md-6">

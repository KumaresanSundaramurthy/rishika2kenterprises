                    ...
                    <div class="card mb-3">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-3" id="transHeaderInfo">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    <div class="input-group w-auto">
                                        ...
                                        function buildPRInitialPrefixSegment($cfg) {
                                            if (!$cfg) return '';
                                            $sep = $cfg->Separator ?? '-';
                                            $parts = [$cfg->Name];
                                        ...
                                        $initialPrefixSeg = buildPRInitialPrefixSegment($defaultPrefixConfig);
                        ...
                        <div class="card-body card-body-form-static p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2"><label for="transNotes" class="form-label small fw-semibold">Notes</label><textarea class="form-control" name="transNotes" id="transNotes" rows="2" placeholder="Reason for return"></textarea></div>

...
if (!empty($DataLists)) {
    foreach ($DataLists as $list) {
        ...
        $isApproved  = ($list->Status === 'Approved');
            ...
            <td>
                ...
                <?php else: ?>
                    <span class="fw-semibold text-primary">
                        <a href="javascript:void(0)" class="text-decoration-underline viewSalesReturn" data-uid="<?php echo (int) $list->TransUID; ?>">
                ...
                <div class="d-flex align-items-center justify-content-center gap-1">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                            <?php if (!$isDraft): ?>
                            <li>
                                <button class="dropdown-item a4PrintSalesReturn" data-uid="<?php echo (int) $list->TransUID; ?>">
    ...
    <tr>
        <td colspan="9">
            <div class="d-flex flex-column align-items-center py-5">
                ...
                <span class="text-muted mb-3">No sales returns found</span>

    ...
    <tr class="<?php echo $isOverdueRow ? 'trans-row-overdue' : ''; ?>">
        ...
        <td>
            <?php if ($isDraft || empty($list->UniqueNumber)): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a href="javascript:void(0)" class="trans-doc-number viewSalesOrder" data-uid="<?php echo (int)$list->TransUID; ?>">
            ...
            <div class="d-flex align-items-center justify-content-center gap-1">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="font-size:.82rem;min-width:160px;">
                        ...
                        <?php if (!$isDraft): ?>
                        <li>
                            <button class="dropdown-item thermalPrintSalesOrder" data-uid="<?php echo (int)$list->TransUID; ?>">
                                <i class="bx bx-receipt me-2 text-dark"></i>Thermal Print
                            </button>
                        </li>
                        <li>
                            <button class="dropdown-item a4PrintSalesOrder" data-uid="<?php echo (int)$list->TransUID; ?>">

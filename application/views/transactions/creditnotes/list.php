    ...
    <tr>
        ...
        <td>
            <?php if ($isDraft || empty($list->UniqueNumber)): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a href="javascript:void(0)" class="trans-doc-number viewTransaction" data-uid="<?php echo (int)$list->TransUID; ?>" data-module="<?php echo (int)$list->ModuleUID; ?>" data-type="creditnote" data-number="<?php echo htmlspecialchars($list->UniqueNumber ?? ''); ?>" data-date="<?php echo htmlspecialchars($list->TransDate ?? ''); ?>" data-status="<?php echo htmlspecialchars($list->Status ?? ''); ?>">
            ...
            <div class="d-flex align-items-center justify-content-end gap-1">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="font-size:.82rem;min-width:160px;">
                        ...
                        <?php if (!$isDraft): ?>
                        <li>
                            <button class="dropdown-item text-warning cn-status-update"
                                    data-uid="<?php echo (int)$list->TransUID; ?>"
    ...
    <tr>
        <td colspan="9">
            <div class="d-flex flex-column align-items-center py-5">
                ...
                <span class="text-muted mb-3" style="font-size:.9rem;">No credit notes found</span>
                <a href="/creditnotes/create" class="btn btn-primary btn-sm px-4">

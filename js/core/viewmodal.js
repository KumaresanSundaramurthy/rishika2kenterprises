        ...
        (resp.Items || []).forEach(function (item, i) {
            ...
            '<tr>' +
                ...
                '<td>' +
                    ...
                    (item.VariantLabel ? '<div class="vtm-item-sub"><i class="bx bx-layer me-1"></i>' + _esc(item.VariantLabel) + '</div>' : (item.BrandName ? '<div class="vtm-item-sub"><i class="bx bx-purchase-tag-alt me-1"></i>' + _esc(item.BrandName) + '</div>' : '')) +
                '</td>' +

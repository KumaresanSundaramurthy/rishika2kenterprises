                            ...
                            <div class="d-flex flex-wrap align-items-center gap-3" id="transHeaderInfo">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    <div class="input-group w-auto">
                                        ...
                                        function buildSOInitialPrefixSegment($cfg) {
                                            if (!$cfg) return '';
                                            $sep    = $cfg->Separator ?? '-';
                                            $parts  = [$cfg->Name];
                                        ...
                                        $initialPrefixSeg = buildSOInitialPrefixSegment($defaultPrefixConfig);
                                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        ...
                                        <textarea class="form-control" name="transNotes" id="transNotes" rows="2" placeholder="Enter notes or anything else"><?php echo !empty($QuotationData->Notes) ? htmlspecialchars($QuotationData->Notes) : ''; ?></textarea>
                                    </div>
                                    <div class="mb-2">
                                        <label for="transTermsCond" class="form-label small fw-semibold">Terms & Conditions</label>
                                        <textarea class="form-control" name="transTermsCond" id="transTermsCond" rows="2" placeholder="Enter business terms & conditions"><?php echo !empty($QuotationData->TermsConditions) ? htmlspecialchars($QuotationData->TermsConditions) : "1. Goods once sold will not be taken back or exchanged\n2. All disputes are subject to Gingee jurisdiction only"; ?></textarea>
                                    </div>
                                </div>

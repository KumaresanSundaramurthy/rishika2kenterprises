    ...
    <tr>
        ...
        <td>
            <?php if ($isDraft || empty($list->UniqueNumber)): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a href="javascript:void(0)" class="trans-doc-number viewTransaction" data-uid="<?php echo (int)$list->TransUID; ?>" data-module="<?php echo (int)$list->ModuleUID; ?>" data-type="salesreturn">

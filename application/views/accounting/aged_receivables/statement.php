...
<div class="aged-statement pl-print-header" id="arStatement">
    ...
    <div class="text-center mb-3">
        ...
        <div class="fw-semibold" style="font-size:.92rem;">Aged Receivables</div>
    ...
    <div class="text-center text-muted py-4" style="font-size:.88rem;">
        ...
        No outstanding receivables as of <?php echo $asOfDisp; ?>
    </div>
    <?php else: ?>
    ...
    <div class="text-muted mt-2" style="font-size:.72rem;">
        Aging is based on FIFO matching of payments against oldest invoices.

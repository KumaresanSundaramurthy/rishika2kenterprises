                ...
                <div class="card mb-3">
                    <div class="card-header bg-body-tertiary trans-header-static trans-theme modal-header-center-sticky d-flex justify-content-between align-items-center pb-3">
                        <div class="d-flex flex-wrap align-items-center gap-3" id="transHeaderInfo">
                            ...
                            <?php if (!$isDraftEdit && !empty($DNData->UniqueNumber)): ?><span class="trans-form-doc-number"><?php echo htmlspecialchars($DNData->UniqueNumber); ?></span><?php endif; ?>
...
$(function() {
    'use strict'
    initTransAttachments(<?php echo (int)$DNData->TransUID; ?>, '/debitnotes/getAttachments');
    ...
    if ($form.length) {
        $form.on('submit', function(e) {
            ...
            $.ajax({ url: '/debitnotes/updateDebitNote', method: 'POST', data: formData, processData: false, contentType: false, cache: false,

                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header bg-body-tertiary trans-header-static trans-theme modal-header-center-sticky d-flex justify-content-between align-items-center pb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button type="submit" class="btn btn-primary AddEditVendorBtn">Create</button>
                                            ...
                                            <?php if (sizeof($CountryInfo) > 0) {
                                                foreach ($CountryInfo as $Country) { ?>
                                                    <option
                                                        ...
                                                        <?php echo (isset($EditData->CountryCode) && $EditData->CountryCode == $Country->phone[0]) ? 'selected' : ($Country->iso->{'alpha-2'} == $JwtData->Org->OrgCISO2 ? 'selected' : ''); ?>>
                            ...
                            <div class="table-responsive <?php echo count($BankDetails) > 0 ? '' : 'd-none'; ?>" id="appendBankDetails">
                                <table class="table table-bordered table-sm align-middle mb-0">
                                    ...
                                    <?php if(count($BankDetails) > 0) {
                                        ...
                                        <tr data-id="<?php echo 'New-'.$BDet->VendBankDetUID; ?>" data-type="<?php echo $BDet->Type; ?>" data-record='<?php echo json_encode([
                                                "id"       => 'New-'.$BDet->VendBankDetUID,
                                                "type"     => $BDet->Type,
...
$(function() {
    ...
    <?php if (!empty($BillingAddr)) { ?>
        ...
        const billingData = <?php echo json_encode($BillingAddr); ?>;
            $('#BillAddressUID').val(billingData.VendAddressUID || 0);
    ...
    <?php } if (!empty($ShippingAddr)) { ?>
        ...
        const shippingData = <?php echo json_encode($ShippingAddr); ?>;
            $('#ShipAddressUID').val(shippingData.VendAddressUID || 0);

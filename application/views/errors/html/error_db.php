...
<body>
    <div class="err-card">
        ...
        <h1 class="err-title">Connection Problem</h1>
        <p class="err-msg">We couldn't reach the database right now.<br>Please check your connection and try again in a moment.</p>

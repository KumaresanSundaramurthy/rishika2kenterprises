        ...
        <div class="layout-page">
            <div class="content-wrapper apex-content">
                <?php $this->load->view('common/apex/page_header', [
                    ...
                    'pageDescription' => 'Pending payables to suppliers',
                        ...
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Suppliers</div>
                                    <div class="rpt-stat-val" id="soStatSuppliers">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="soStatBills">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                <div class="rpt-stat-icon rpt-icon-teal"><i class="bx bx-wallet-alt"></i></div>
                                <div class="rpt-stat-body">
                                    <div class="rpt-stat-label">Total Billed</div>
                                    <div class="rpt-stat-val" id="soStatBilled">—</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="rpt-stat-card">
                                ...
                                <div class="rpt-stat-body">
                                    ...
                                    <div class="rpt-stat-val" id="soStatOutstanding">—</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="rpt-table-wrap">
                            <table class="rpt-table">
                                ...
                                <tfoot id="soTableFoot" class="d-none">
                                    <tr>
                                        <td colspan="4">Total</td>
                                        <td class="rpt-col-num" id="soFtBills"></td>
                                        <td class="rpt-col-num rpt-num-blue" id="soFtBilled"></td>
                                        <td class="rpt-col-num" id="soFtPaid"></td>
                                        <td class="rpt-col-num rpt-num-orange" id="soFtOutstanding"></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="rpt-tbl-footer d-none" id="soTblFooter">
                            <div class="rpt-footer-left"><span id="soRowCount"></span></div>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rpt-footer-chip rpt-footer-chip-orange"><i class="bx bx-error-circle"></i>Outstanding: <span id="soFooterOutstanding"></span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
var _soToday   = '<?php echo $_today; ?>';
var _soListFmt = '<?php echo addslashes($_listFmt); ?>';
ajaxLoading(0);
...
<script src="/js/reports/supplier_outstanding.js"></script>

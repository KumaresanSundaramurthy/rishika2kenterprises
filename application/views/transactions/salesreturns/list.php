    ...
    <tr>
        ...
        <td>
            <?php if ($isDraft || empty($list->UniqueNumber)): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a href="javascript:void(0)" class="trans-doc-number viewTransaction" data-uid="<?php echo (int)$list->TransUID; ?>" data-module="<?php echo (int)$list->ModuleUID; ?>" data-type="salesreturn" data-number="<?php echo htmlspecialchars($list->UniqueNumber ?? ''); ?>" data-date="<?php echo htmlspecialchars($list->TransDate ?? ''); ?>" data-status="<?php echo htmlspecialchars($list->Status ?? ''); ?>">
        ...
        <td>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width:170px;font-size:.82rem;">
                    ...
                    <li>
                        <button class="dropdown-item sr-status-update"
                                data-uid="<?php echo (int)$list->TransUID; ?>"
        ...
        <td>
            <?php if (!$isDraft && !empty($list->ValidityDate)): ?>
                <span class="text-muted" style="font-size:.82rem;"><?php echo format_datedisplay($list->ValidityDate, 'd M Y'); ?></span>
            <?php else: ?>
                <span class="text-muted">—</span>
            <?php endif; ?>
        </td>
        ...
        <td style="width:50px">
            <div class="d-flex align-items-center justify-content-end gap-1">
                ...
                <?php if (!$isTerminal): ?>
                <a class="btn btn-icon btn-sm text-warning" href="/salesreturns/edit/<?php echo (int)$list->TransUID; ?>" title="Edit">

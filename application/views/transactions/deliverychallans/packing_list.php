...
$_pFmt      = $JwtData->GenSettings->PrintDateFormat ?? 'd M Y';
$dispatchDt = !empty($h->TransDate)    ? format_datedisplay($h->TransDate, $_pFmt)    : '—';
$returnDt   = !empty($h->ValidityDate) ? format_datedisplay($h->ValidityDate, $_pFmt) : '—';
